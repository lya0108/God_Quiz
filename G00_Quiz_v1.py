...
class main:
    def __init__(self):
        ...
        self.play_button = Button(self.entry_frame, text="Play", font=button_font, fg=button_fg, bg="#c721fd", activebackground="#8b17b1", activeforeground="#ffffff", width=5, command=lambda: self.num_question())
        ...
        self.stats_button = Button(self.button_frame, text="Stats", font=button_font, bg="#14eceb", fg=button_fg, activebackground="#006464", activeforeground="#ffffff", width=10,state=DISABLED)
        self.stats_button.grid(row=0, column=0, padx=10)

        self.help_button = Button(self.button_frame, text="Help", font=button_font, bg="#F23390", fg=button_fg, activebackground="#b40b5e", activeforeground="#ffffff", width=10, command=self.to_help)
...
class Play:
    def __init__(self, how_many):
        ...
        self.help_button = Button(self.help_next_frame, text="Help", font=button_font, bg="#F23390", fg=button_fg, activebackground="#b40b5e", activeforeground="#ffffff", width=10, command=self.to_help)
        self.help_button.grid(row=0, column=0, padx=10)

        self.next_button = Button(self.help_next_frame, text="Next", font=button_font, bg="#00bfff", fg=button_fg, activebackground="#0086b3", activeforeground="#ffffff", width=10, command=self.new_round)
    ...
    def new_round(self):
        ...
        gods = self.get_round_gods()
        round_ans = random.choice(gods)

        self.question_box.config(text=f"Who is the {round_ans[0]} {round_ans[2]}")
...
class DisplayHelp:
    def __init__(self, partner):
        ...
        helpinfo = "Enter Number of Questions Then Press Enter. A question will appear. When you select a god the game will tell you whether you've won or not. Then press 'Next' to move on"
